Calculadora basica:
Lo que recreamos fue una calculadora basica con operaciones basicas, la que nos permite resolver ejercicios de, suma, resta , división y multiplicacion.
Se le represente mediante una interfaz grafica, que cumple con los requerimientos de una calculadora en fisico.
Utilize la plataforma tkinter para que sea de una mejpr calidad y un buen formato.
...
class Interfaz:
    def __init__(self, ventana):
        ...
        self.pantalla=Text(ventana, state="disabled", width=20, height=2, background="white", foreground="black")
